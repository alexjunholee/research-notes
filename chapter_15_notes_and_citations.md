...
AI가 만든 5 Cs 노트는 초안이다. 그대로 보관하지 않는다. 최종 노트에는 AI 문장을 남기는 대신, 본인이 확인한 claim과 위치를 남긴다. hallucination의 가장 위험한 형태는 *그럴듯한 citation 위치*다. section·table·equation 번호가 맞지 않으면 그 항목은 버린다.
