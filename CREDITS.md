...
이 책은 아래 자료에서 많은 것을 배웠다. 본문은 원문을 장별로 요약한 것이 아니라, 로보틱스와 컴퓨터비전 연구를 시작하는 학생의 작업 흐름에 맞게 다시 엮은 산문이다. 그래도 출발점은 분명히 남겨 둔다. 좋은 생각은 원래 나온 자리로 돌아갈 수 있어야 한다.
...
- Ignacio Vizzo, Tiziano Guadagnino, Benedikt Mersch, Louis Wiesmann, Jens Behley, Cyrill Stachniss, "KISS-ICP: In Defense of Point-to-Point ICP"
- Raul Mur-Artal, J. M. M. Montiel, Juan D. Tardos, "ORB-SLAM: A Versatile and Accurate Monocular SLAM System"
- Kaiming He, Xiangyu Zhang, Shaoqing Ren, Jian Sun, "Deep Residual Learning for Image Recognition"
- Chen, Vizzo, Laebe, Behley, Stachniss의 range-image 기반 LiDAR localization 계열 논문과 Stachniss group의 figure 구성
- August Kekule의 벤젠 고리 일화. 이 책에서는 연구 문제와 휴식의 관계를 설명하는 사례로만 다룬다.

## 자매 자료

- [robotics-practice](../robotics-practice/)의 Spatial AI, SLAM, CV 연구 운영 메모
- [grad-notes](../grad-notes/)의 박사과정 운영 메모

## 이 책의 흐름

이 책은 네 묶음으로 읽힌다. 먼저 넓은 관심을 좁은 질문으로 바꾸는 법을 본다. 그 다음 읽기를 양이 아니라 판단의 문제로 다룬다. 세 번째 묶음은 그 판단을 논문의 골격과 증거로 바꾸는 일이다. 마지막에는 학회를 결과의 전시장보다 다음 질문을 얻는 장소로 본다. 읽기, 쓰기, 발표는 따로 떨어진 기술이 아니라 같은 연구가 통과하는 네 국면이다.
